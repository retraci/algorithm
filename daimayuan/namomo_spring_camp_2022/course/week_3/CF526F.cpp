...
#define rs(x) (tr[x].rson)
    ...
    inline void init(int L, int R) {
        ...
        tr[0].sum = tr[0].lz = tr[0].mi = tr[0].cnt = 0;
    }
    ...
    inline int new_node() {
        ...
        tr[id].sum = tr[id].lz = tr[id].mi = tr[id].cnt = 0;
        return id;
    }
    ...
    inline void push_up(Node &fa, Node &lc, Node &rc) {
        ...
        fa.cnt = 0;
        if (lc.mi == fa.mi) fa.cnt += lc.cnt;
        if (rc.mi == fa.mi) fa.cnt += rc.cnt;
    }
